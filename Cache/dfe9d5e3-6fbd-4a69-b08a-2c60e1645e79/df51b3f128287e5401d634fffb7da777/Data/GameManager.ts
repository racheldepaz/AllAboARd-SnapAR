...
export class GameManager extends BaseScriptComponent {
    ...
    onStart(): void {
        ...
        this.playerCountProp.onValueChanged.add(this.onPlayerCountChanged.bind(this));
        this.gameReadyProp.onValueChanged.add(this.onGameReadyChanged.bind(this));
    ...
    setupSyncProperties(): void {
        ...
        this.playerCountProp = StorageProperty.forNumber(0);
        this.gameReadyProp = StorageProperty.forBoolean(false);
    ...
    registerPlayer(): void {
        ...
        this.syncEntity.onReady.add(() => {
            // Increment player count
            this.playerCountProp.value = this.playerCountProp.value + 1;
    ...
    onPlayerCountChanged(newCount: number): void {
        ...
        console.log("Player count changed: " + newCount);
        ...
        if (newCount >= 2) {
            this.gameReadyProp.value = true;
        } else {
            this.gameReadyProp.value = false;
        }
    }
