...
export class GameManager extends BaseScriptComponent {
    ...
    onStart(): void {
        ...
        this.playerCountProp.onChanged.add(this.onPlayerCountChanged.bind(this));
        this.gameReadyProp.onChanged.add(this.onGameReadyChanged.bind(this));
    ...
    setupSyncProperties(): void {
        ...
        this.playerCountProp = new StorageProperty<number>(0);
        this.gameReadyProp = new StorageProperty<boolean>(false);
    ...
    registerPlayer(): void {
        ...
        this.syncEntity.onReady.add(() => {
            ...
            const currentCount = this.playerCountProp.value || 0;
            this.playerCountProp.value = currentCount + 1;
