...
export class StringController extends BaseScriptComponent {
    ...
    updateStringVisual(): void {
        ...
        if (this.stringVisual) {
            ...
            // Create a rotation that aligns with the direction
            const up = new vec3(0, 1, 0);
            const rotation = this.createRotationFromDirection(direction, up);
    ...
    // Helper function to create rotation from direction
    createRotationFromDirection(direction: vec3, up: vec3): quat {
        // Create a rotation that aligns with the direction
        // This is a simplified version of lookRotation
        ...
        return quat.fromMat3(rotMatrix);
    }
}
